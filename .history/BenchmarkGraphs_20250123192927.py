...
instances = [10,20,30,50,70,90,110]
edges = [18,32,44,127,120,290,259,798,482,1558,823,2577,1255,3902]

for i in range(len(instances)):
    name_lo = str(instances[i]) + "nodes_"+ str(0.1) + "prob_" + str(edges[2*i])
    name_hi = str(instances[i]) + "nodes_"+ str(0.4) + "prob_" + str(edges[2*i + 1])
