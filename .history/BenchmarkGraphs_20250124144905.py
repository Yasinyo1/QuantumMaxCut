...
def run_quantum_implementation(graph, instance_name):
    with open(f"results/{instance_name}.txt", "a") as result_file:
        ...
        with Session(backend=backend) as session:
            ...
            estimator.options.default_shots = 20
        ...
        with Session(backend=backend) as session:
            ...
            sampler.options.default_shots = 20
...
#     run_classical_implementation(graph_lo, name_lo)
#     run_classical_implementation(graph_hi, name_hi)
